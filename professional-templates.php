...
<head>
    ...
    <meta name="description" content="Explore premium Professional portfolio templates.">
    <title>Professional Templates — PortfolioGen</title>
...
<body class="page-category">
    ...
    <main>
        <section class="template-page-hero">
            ...
            <h1 class="section-title">Professional <span class="gradient-text">Templates</span></h1>
            <p class="section-subtitle">Sophisticated, corporate-ready designs for executives and business leaders.</p>
        </section>
        ...
        <section class="template-filters-section">
            <div class="template-search-wrapper">
                ...
                <input type="text" class="template-search-input" placeholder="Search professional templates...">
            </div>
        ...
        <div class="template-grid">
            ...
            <div class="tm-card" data-category="corporate">
                <div class="tm-card-header">
                    <img src="assets/img/portfolio-img5.jpg" alt="Stellar" class="tm-card-img" style="filter: brightness(0.9);">
