...
<head>
    ...
    <meta name="description" content="Explore premium Architecture portfolio templates.">
    <title>Architecture Templates — PortfolioGen</title>
...
<body class="page-category">
    ...
    <main>
        <section class="template-page-hero">
            ...
            <h1 class="section-title">Architecture <span class="gradient-text">Templates</span></h1>
            <p class="section-subtitle">Geometric, structural designs for architects and interior designers.</p>
        </section>
        ...
        <section class="template-filters-section">
            <div class="template-search-wrapper">
                ...
                <input type="text" class="template-search-input" placeholder="Search architecture templates...">
            </div>
            <div class="filter-group">
                <button class="filter-btn active">All</button>
                <button class="filter-btn">Studio</button>
                <button class="filter-btn">Modernist</button>
            </div>
        </section>

        <div class="template-grid">
            <!-- Template Card 1 -->
            <div class="tm-card" data-category="studio">
                <div class="tm-card-header">
                    <img src="assets/img/portfolio-img3.jpg" alt="Phantom" class="tm-card-img" style="filter: sepia(0.3) brightness(0.8);">
