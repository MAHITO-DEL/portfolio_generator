...
<head>
    ...
    <meta name="description" content="Explore premium Minimal portfolio templates.">
    <title>Minimal Templates — PortfolioGen</title>
...
<body class="page-category">
    ...
    <main>
        <section class="template-page-hero">
            ...
            <h1 class="section-title">Minimal <span class="gradient-text">Templates</span></h1>
            <p class="section-subtitle">Clean, typography-driven designs that let your work breathe.</p>
        </section>
        ...
        <section class="template-filters-section">
            <div class="template-search-wrapper">
                ...
                <input type="text" class="template-search-input" placeholder="Search minimal templates...">
            </div>
            <div class="filter-group">
                <button class="filter-btn active">All</button>
                <button class="filter-btn">Clean</button>
        ...
        <div class="template-grid">
            <!-- Template Card 1 -->
            <div class="tm-card" data-category="clean">
                <div class="tm-card-header">
                    <img src="assets/img/portfolio-img3.jpg" alt="Aerial" class="tm-card-img" style="filter: grayscale(1);">
                ...
                <div class="tm-card-body">
                    ...
                    <p class="tm-card-desc">A single-page, floating-content theme that is as light as air.</p>
            ...
            <!-- Template Card 2 -->
            <div class="tm-card" data-category="modern">
                <div class="tm-card-header">
                    <img src="assets/img/portfolio-img5.jpg" alt="Dimension" class="tm-card-img" style="filter: brightness(0.7);">
                    <div class="tm-card-actions">
                        <button class="tm-action-btn"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg></button>
                    </div>
                </div>
                <div class="tm-card-body">
                    <div class="tm-card-top">
                        <h3 class="tm-card-title">Dimension</h3>
                        <div class="tm-rating"><span>★</span> 4.9</div>
                    </div>
                    <p class="tm-card-desc">A fully responsive, single page toolkit built with a unique modal-driven layout.</p>
                    <div class="tm-card-footer">
                        <span class="tm-price">Free</span>
                        <a href="generator.php" class="tm-use-btn">Use Template</a>
                    </div>
    ...
    <script src="assets/js/script.js?v=<?php echo filemtime('assets/js/script.js'); ?>" defer>
